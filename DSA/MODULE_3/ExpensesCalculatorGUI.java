...
public class ExpensesCalculatorGUI extends javax.swing.JFrame {
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        .addGroup(jPanel1Layout.createSequentialGroup()
                                                ...
                                                .addGroup(jPanel1Layout
                                                        ...
                                                        .addComponent(billName, javax.swing.GroupLayout.PREFERRED_SIZE,
    ...
    private void addButtonActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        if(billName.getText().compareTo("")==0){
            JOptionPane.showMessageDialog(this, "Insert Bill Name!");
            return;
        }if (billAmount.getText().compareTo("")==0){
         JOptionPane.showMessageDialog(this, "Insert Bill Amount!");
            return;
    }
    ...
    private void SortActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        double bAmount2;
        int inner = 0;
        for (int outer = 1; outer < jTable1.getRowCount(); outer++) {
            inner = outer - 1;
            key = Double.valueOf(jTable1.getValueAt(outer, 1).toString()); 
            name1 = jTable1.getValueAt(outer, 0).toString();
            
            bAmount = Double.valueOf(jTable1.getValueAt(inner, 1).toString()); 
            while (inner >= 0 && bAmount > key) {
                bAmount2 = Double.valueOf(jTable1.getValueAt(inner, 1).toString()); 
                name2 = jTable1.getValueAt(inner, 0).toString();
                
                jTable1.setValueAt(bAmount2, inner+1, 1);
                jTable1.setValueAt(name2, inner+1, 0);

                inner--;
            }
             jTable1.setValueAt(key, inner+1, 1);
             jTable1.setValueAt(name1, inner+1, 0);

               
        }
        long time = System.nanoTime() - start;
        System.out.println("Processing time: " + time+ " units");
    }
