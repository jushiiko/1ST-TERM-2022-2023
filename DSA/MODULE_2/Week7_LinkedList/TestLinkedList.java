...
public class TestLinkedList extends JFrame implements ActionListener, ItemListener, KeyListener {
    ...
    TestLinkedList() {
        ...
        String menu[] = { "Add At First", "Add At Position", "Add At Last",
                ...
                "Get First", "Get At Position", "IndexAt", "Get Last", "Add In Middle", "Delete In Middle", "Delete Value" };
